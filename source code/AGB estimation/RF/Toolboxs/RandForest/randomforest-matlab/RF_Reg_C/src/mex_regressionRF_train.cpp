        ...
        
{
    ...
    plhs[8] = mxCreateNumericMatrix(n_size, 1, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    ...
    if (imp[0]==1){
        ...
        plhs[10] = mxCreateNumericMatrix(p_size, 2, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
        impout = mxGetPr(plhs[10]); //(double*) calloc(p_size*2, sizeof(double));
        if (DEBUG_ON) printf("impout %d\n", p_size*2);
    }else{
        //double impout[p_size];
        plhs[10] = mxCreateNumericMatrix(p_size, 1, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    ...
    if(imp[1]==1){
        ...
        plhs[11] = mxCreateNumericMatrix(p_size, n_size, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
        impmat = mxGetPr(plhs[11]); //(double*) calloc(p_size*n_size, sizeof(double));
        if (DEBUG_ON) printf("impmat %d\n", p_size*n_size);
    }else{
        //double impmat=1;
        plhs[11] = mxCreateNumericMatrix(1, 1, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    ...
    if(imp[0]==1){
        //double impSD[p_size];
        plhs[12] = mxCreateNumericMatrix(p_size, 1, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
        impSD = mxGetPr(plhs[12]); //(double*)calloc(p_size, sizeof(double));
        if (DEBUG_ON) printf("impSD %d\n", p_size);
    }else{
        //double impSD=1;
        plhs[12] = mxCreateNumericMatrix(1, 1, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    ...
    double *prox;
    if (doProx){
        plhs[13] = mxCreateNumericMatrix(n_size,n_size,mxDOUBLE_CLASS,static_cast<mxComplexity>(0));
        prox = mxGetPr(plhs[13]);
    }else{
        plhs[13] = mxCreateNumericMatrix(1,1,mxDOUBLE_CLASS,static_cast<mxComplexity>(0));
        prox = mxGetPr(plhs[13]);
    }
    ...
    plhs[7] = mxCreateNumericMatrix(ntree, 1, mxINT32_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[2] = mxCreateNumericMatrix(nrnodes, nt, SMALL_INT_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[0] = mxCreateNumericMatrix(nrnodes, nt, mxINT32_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[1] = mxCreateNumericMatrix(nrnodes, nt, mxINT32_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[5] = mxCreateNumericMatrix(nrnodes, nt, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[6] = mxCreateNumericMatrix(nrnodes, nt, mxINT32_CLASS, static_cast<mxComplexity>(0));
    ...
    plhs[4] = mxCreateNumericMatrix(nrnodes, nt, mxDOUBLE_CLASS, static_cast<mxComplexity>(0));
    double *upper=(double*)mxGetData(plhs[4]);
    if (DEBUG_ON) printf("upper %d\n", nrnodes*nt);
    
    plhs[9] = mxCreateNumericMatrix(ntree,1,mxDOUBLE_CLASS,static_cast<mxComplexity>(0));
    ...
    plhs[14] = mxCreateNumericMatrix(2,1,mxDOUBLE_CLASS,static_cast<mxComplexity>(0));
    double *coef = mxGetPr(plhs[14]);
    
    
    //int nout[n_size];
    plhs[15] = mxCreateNumericMatrix(n_size,1,mxINT32_CLASS,static_cast<mxComplexity>(0));
    int* nout = (int*)mxGetData(plhs[15]); //(int*)calloc(n_size, sizeof(int));
    
    int* inbag;
    if (keepf[1]==1){
        plhs[16] = mxCreateNumericMatrix(n_size,ntree,mxINT32_CLASS,static_cast<mxComplexity>(0));
        inbag=(int*)mxGetData(plhs[16]);//calloc(n_size*ntree, sizeof(int));
    }else{
        plhs[16] = mxCreateNumericMatrix(1,1,mxINT32_CLASS,static_cast<mxComplexity>(0));
